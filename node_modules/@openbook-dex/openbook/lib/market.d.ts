...
export declare class Market {
    ...
    findOpenOrdersAccountsForOwner(connection: Connection, ownerAddress: PublicKey, cacheDurationMs?: number, forceSeedAccount?: boolean): Promise<OpenOrders[]>;
...
export declare class OpenOrders {
    ...
    static getLayout(programId: PublicKey): any;
    static getDerivedOOAccountPubkey(ownerAddress: PublicKey, marketAddress: PublicKey, programId: PublicKey): Promise<{
        publicKey: PublicKey;
        seed: string;
    }>;
    static findForOwner(connection: Connection, ownerAddress: PublicKey, programId: PublicKey): Promise<OpenOrders[]>;
    static findForMarketAndOwner(connection: Connection, marketAddress: PublicKey, ownerAddress: PublicKey, programId: PublicKey, forceSeedAccount?: boolean): Promise<OpenOrders[]>;
    ...
    static makeCreateAccountTransaction(connection: Connection, marketAddress: PublicKey, ownerAddress: PublicKey, newAccountAddress: PublicKey, programId: PublicKey, seed: string): Promise<TransactionInstruction>;
    get publicKey(): PublicKey;
}
