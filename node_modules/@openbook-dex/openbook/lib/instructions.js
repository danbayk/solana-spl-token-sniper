...
exports.INSTRUCTION_LAYOUT = new layout_1.VersionedLayout(0, (0, buffer_layout_1.union)((0, buffer_layout_1.u32)('instruction')));
exports.INSTRUCTION_LAYOUT.inner.addVariant(0, (0, buffer_layout_1.struct)([
    (0, layout_1.u64)('baseLotSize'),
    (0, layout_1.u64)('quoteLotSize'),
    (0, buffer_layout_1.u16)('feeRateBps'),
    (0, layout_1.u64)('vaultSignerNonce'),
    (0, layout_1.u64)('quoteDustThreshold'),
]), 'initializeMarket');
exports.INSTRUCTION_LAYOUT.inner.addVariant(1, (0, buffer_layout_1.struct)([
    (0, layout_1.sideLayout)('side'),
    (0, layout_1.u64)('limitPrice'),
    (0, layout_1.u64)('maxQuantity'),
    (0, layout_1.orderTypeLayout)('orderType'),
    (0, layout_1.u64)('clientId'),
]), 'newOrder');
exports.INSTRUCTION_LAYOUT.inner.addVariant(2, (0, buffer_layout_1.struct)([(0, buffer_layout_1.u16)('limit')]), 'matchOrders');
exports.INSTRUCTION_LAYOUT.inner.addVariant(3, (0, buffer_layout_1.struct)([(0, buffer_layout_1.u16)('limit')]), 'consumeEvents');
exports.INSTRUCTION_LAYOUT.inner.addVariant(4, (0, buffer_layout_1.struct)([
    (0, layout_1.sideLayout)('side'),
    (0, layout_1.u128)('orderId'),
    (0, layout_1.publicKeyLayout)('openOrders'),
    (0, buffer_layout_1.u8)('openOrdersSlot'),
]), 'cancelOrder');
exports.INSTRUCTION_LAYOUT.inner.addVariant(5, (0, buffer_layout_1.struct)([]), 'settleFunds');
exports.INSTRUCTION_LAYOUT.inner.addVariant(6, (0, buffer_layout_1.struct)([(0, layout_1.u64)('clientId')]), 'cancelOrderByClientId');
exports.INSTRUCTION_LAYOUT.inner.addVariant(10, (0, buffer_layout_1.struct)([
    (0, layout_1.sideLayout)('side'),
    (0, layout_1.u64)('limitPrice'),
    (0, layout_1.u64)('maxBaseQuantity'),
    (0, layout_1.u64)('maxQuoteQuantity'),
    (0, layout_1.selfTradeBehaviorLayout)('selfTradeBehavior'),
    (0, layout_1.orderTypeLayout)('orderType'),
    (0, layout_1.u64)('clientId'),
    (0, buffer_layout_1.u16)('limit'),
]), 'newOrderV3');
exports.INSTRUCTION_LAYOUT.inner.addVariant(11, (0, buffer_layout_1.struct)([(0, layout_1.sideLayout)('side'), (0, layout_1.u128)('orderId')]), 'cancelOrderV2');
exports.INSTRUCTION_LAYOUT.inner.addVariant(12, (0, buffer_layout_1.struct)([(0, layout_1.u64)('clientId')]), 'cancelOrderByClientIdV2');
exports.INSTRUCTION_LAYOUT.inner.addVariant(13, (0, buffer_layout_1.struct)([
    (0, layout_1.sideLayout)('side'),
    (0, layout_1.u64)('limitPrice'),
    (0, layout_1.u64)('maxBaseQuantity'),
    (0, layout_1.u64)('maxQuoteQuantity'),
    (0, layout_1.u64)('minBaseQuantity'),
    (0, layout_1.u64)('minQuoteQuantity'),
    (0, buffer_layout_1.u16)('limit'),
]), 'sendTake');
exports.INSTRUCTION_LAYOUT.inner.addVariant(14, (0, buffer_layout_1.struct)([]), 'closeOpenOrders');
exports.INSTRUCTION_LAYOUT.inner.addVariant(15, (0, buffer_layout_1.struct)([]), 'initOpenOrders');
exports.INSTRUCTION_LAYOUT.inner.addVariant(16, (0, buffer_layout_1.struct)([(0, buffer_layout_1.u16)('limit')]), 'prune');
exports.INSTRUCTION_LAYOUT.inner.addVariant(17, (0, buffer_layout_1.struct)([(0, buffer_layout_1.u16)('limit')]), 'consumeEventsPermissioned');
exports.INSTRUCTION_LAYOUT.inner.addVariant(18, (0, buffer_layout_1.struct)([(0, buffer_layout_1.seq)((0, layout_1.u64)(), 8, 'clientIds')]), 'cancelOrdersByClientIds');
const orderStruct = () => (0, buffer_layout_1.struct)([
    (0, layout_1.sideLayout)('side'),
    (0, layout_1.u64)('limitPrice'),
    (0, layout_1.u64)('maxBaseQuantity'),
    (0, layout_1.u64)('maxQuoteQuantity'),
    ...
    (0, layout_1.u64)('clientId'),
    (0, buffer_layout_1.u16)('limit'),
    (0, layout_1.i64)('maxTs'),
]);
exports.INSTRUCTION_LAYOUT.inner.addVariant(19, orderStruct(), 'replaceOrderByClientId');
exports.INSTRUCTION_LAYOUT.inner.addVariant(20, (0, buffer_layout_1.struct)([(0, layout_1.u64)('orderAmount'), (0, buffer_layout_1.seq)(orderStruct(), 8, 'orders')]), 'replaceOrdersByClientIds');
exports.INSTRUCTION_LAYOUT_V2 = new layout_1.VersionedLayout(0, (0, buffer_layout_1.union)((0, buffer_layout_1.u32)('instruction')));
...
class DexInstructions {
    ...
    static sendTake({ market, requestQueue, eventQueue, bids, asks, baseWallet, quoteWallet, owner, baseVault, quoteVault, vaultSigner, side, limitPrice, maxBaseQuantity, maxQuoteQuantity, minBaseQuantity, minQuoteQuantity, limit, programId, feeDiscountPubkey = null, }) {
        const keys = [
            { pubkey: market, isSigner: false, isWritable: true },
            { pubkey: requestQueue, isSigner: false, isWritable: true },
            { pubkey: eventQueue, isSigner: false, isWritable: true },
